...
description: >
  A13 OBS — Owns SLOs, dashboards, alerting and incident declaration. Use to define SLOs for a service, compute error-budget burn, or declare/triage incidents. Spawn as subagent_type a13-observability.
prompt_mode: full
model: inherit
