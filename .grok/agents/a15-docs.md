...
name: a15-docs
description: >
  A15 DOC — Owns docs bundles, API references, runbooks and changelogs. Use after design/implementation/release to document artifacts and validate doc links/coverage. Spawn as subagent_type a15-docs.
prompt_mode: full
model: inherit
