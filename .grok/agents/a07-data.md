...
name: a07-data
description: >
  A07 DATA — Owns data models, schema migrations (expand/contract, reversible) and data contracts. Use for any persistence, migration or pipeline change. Spawn as subagent_type a07-data.
prompt_mode: full
model: inherit
