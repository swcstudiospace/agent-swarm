...
name: a06-frontend
description: >
  A06 FE — Implements UI against A04 tokens/UX specs and A03 API contracts, with component tests and a11y checks. Use for client-side code. Spawn as subagent_type a06-frontend.
prompt_mode: full
model: inherit
